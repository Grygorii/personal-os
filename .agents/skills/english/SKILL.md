...
- **The study deck** — `english/study.html`, published as a Codex Artifact he opens
  ...
  for Codex"**; he pastes that back and you fold it into `progress.json`.
...
Pronunciation ("say it") is enough for a new word; spelling gets its own drills in the
Spelling tab and when he actually misspells — don't spell out every word (he found that
excessive).
...
This wants an *ambient daily* surface (the personal-os Telegram bot). Codex is
